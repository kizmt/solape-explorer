...
export const VaultCard = ({
  ...
  return (
    <div className="solapebox border border-slate-700 rounded p-4 flex flex-col space-y-4">
      <h2 className="card-header text-white">{title}</h2>
      <div className="flex flex-col">
        <h3 className=" text-sm text-neutral-400">Balance</h3>
        <div className="flex space-x-2 items-end text-neutral-400">
      ...
      <div className="flex flex-col">
        <h3 className="text-neutral-400 font-light text-sm">Address</h3>
